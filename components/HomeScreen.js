	...
	return (
		<View style={styles.container}>
			...
			<Text style={styles.sectionText}>
				We are an initiative to relieve loneliness in the company by baking and
				distributing cakes on weekends
			</Text>
			<Text style={styles.sectionText}>
				Every Friday, we delight hundreds of lonely people and fill with a sense
				of pride and mutual guarantee
			</Text>
			<Text style={styles.sectionText}>
				Come join us If you want to help us by baking the world a better place!
			</Text>
			<Text style={styles.sectionText}>
				We currently operate in 12 different locations around the country!
				including:
			</Text>
